package com.orion.manage.web.advice;
...
import com.orion.common.utils.ReflectionUtils;
import com.orion.common.utils.ToStringUtil;
import com.orion.manage.service.mysql.security.TokenService;
import com.orion.manage.web.advice.advicebean.AccessAdviceInfo;
import com.orion.manage.web.advice.advicebean.AdviceException;
...
public class AccessHandleAdvice {
	...
	private static final String EXCEPTION_ADVICE_EXECUTION = "execution(public * com.orion.manage.web.advice.ExceptionHandleAdvice.*(..))";
