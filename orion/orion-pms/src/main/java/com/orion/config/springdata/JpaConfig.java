...
@EnableJpaRepositories(basePackages = {
		"com.orion.manage.*.mysql" }, queryLookupStrategy = Key.CREATE_IF_NOT_FOUND, entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfig {
	...
	public EntityManagerFactory entityManagerFactory() {
		...
		factory.setPackagesToScan("com.orion.manage.model.mysql");
