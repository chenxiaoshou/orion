...
import com.orion.common.cors.CORSConfigurationException;
import com.orion.common.cors.CORSConfigurationLoader;
import com.orion.common.cors.CORSFilter;

/**
 * CORS servlet filter which has the ability to automatically detect changes to
 * the configuration file and reconfigure itself. The configuration file will be
 * checked the next time the filter is invoked and the poll interval has elapsed
