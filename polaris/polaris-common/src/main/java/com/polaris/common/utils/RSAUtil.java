...
public class RSAUtil {
	...
	public static PublicKey getPublicKeyFromBase64(String base64PublicKey) throws Exception {
		return keyFactory.generatePublic(new X509EncodedKeySpec(CodecUtil.fromBase64(base64PublicKey)));
	}
	...
	public static PrivateKey getPrivateKeyFromBase64(String base64PrivateKey) throws Exception {
		return keyFactory.generatePrivate(new PKCS8EncodedKeySpec(CodecUtil.fromBase64(base64PrivateKey)));
	}
	...
	private static void writeToFile(String publicKeyStr, String filePath) throws IOException {
		FileUtils.write(new File(filePath), publicKeyStr, PolarisConstants.CHAESET_UTF_8);
	}
