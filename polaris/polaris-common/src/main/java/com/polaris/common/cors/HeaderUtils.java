...
public class HeaderUtils {
	 ...
	 *
	 * @param set
	 *            The set to serialise. Must not be {@code null}.
	 * @param sep
	 *            The string separator to apply. Should not be {@code null}.
	 *
	...
	/**
	 * Parses a header value consisting of zero or more space / comma / space +
	 * comma separated strings. The input string is trimmed before splitting.
	 *
	 * @param headerValue
	 *            The header value, may be {@code null}.
	 *
	 * @return A string array of the parsed string items, empty if none were
