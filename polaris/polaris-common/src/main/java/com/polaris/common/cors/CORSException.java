...
public class CORSException extends Exception {
	...
	private static final long serialVersionUID = 8199553333743813762L;

	/**
	 * CORS origin denied exception.
	 */
	public static final CORSException ORIGIN_DENIED = new CORSException("CORS origin denied",
			HttpServletResponse.SC_FORBIDDEN);

	/**
	 * Unsupported HTTP method.
	 */
	public static final CORSException UNSUPPORTED_METHOD = new CORSException("Unsupported HTTP method",
	...
	public static final CORSException INVALID_HEADER_VALUE = new CORSException(
			"Invalid preflight CORS request: Bad request header value", HttpServletResponse.SC_BAD_REQUEST);
	...
	/**
	 * Creates a new CORS exception with the specified message and associated
	 * HTTP status code.
	 *
	 * @param message
	 *            The message.
