 ...
 *
 * <p>
 * Use {@link #validate} to check the origin syntax or if you want to query its
...
public class Origin {
	...
	/**
	 * Creates a new origin from the specified URI string. Note that the syntax
	 * is not validated.
	 *
	 * @param value
	 *            The URI string for the origin. Must not be {@code null}.
	 */
	 ...
	 *             If the value doesn't represent a valid and supported origin
	 *             string.
	 *
	 * @return The origin.
	 */
	 ...
	 *
	 * @return {@code true} if the objects are both origins with the same value,
	 *         else {@code false}.
	 */
	@Override
