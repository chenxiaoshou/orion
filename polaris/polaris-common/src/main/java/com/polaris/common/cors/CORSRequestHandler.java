 ...
 *
 * <p>
 * Note that the actual CORS exception handling (which is outside the CORS
...
public class CORSRequestHandler {
	 ...
	 *
	 * @param config
	 *            Specifies the cross-origin access policy. Must not be
	 *            {@code null}.
	 */
	 ...
	 *
	 * <p>
	 * CORS specification: <a href=
	 * "http://www.w3.org/TR/2013/CR-cors-20130129/#resource-requests">Simple
	...
	public void handleActualRequest(final HttpServletRequest request, final HttpServletResponse response)
		...
		if (config.supportsCredentials) {
			...
			// See
			// https://bitbucket.org/thetransactioncompany/cors-filter/issue/16/
	 ...
	 * <p>
	 * CORS specification: <a href=
	 * "http://www.w3.org/TR/2013/CR-cors-20130129/#resource-preflight-requests">Preflight
	 * Request</a>
	 *
	 * @param request
	 *            The HTTP request.
	...
	public void handlePreflightRequest(final HttpServletRequest request, final HttpServletResponse response)
		...
		// Note: method checking must be done after header parsing, see CORS
		// spec
