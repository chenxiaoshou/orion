package com.polaris.config.webconfig;
...
public class WebInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	/**
	 * 配置 Spring 的 org.springframework.web.servlet.DispatcherServlet 的 url-pattern
	 */
	@Override
	...
	/**
	 * 配置应用的上下文，即所有不包括 SpringMVC 等 Web 配置之外的所有配置，
